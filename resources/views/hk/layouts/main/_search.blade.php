...
data-kt-menu-placement="bottom-start"
    ...
    <div data-kt-search-element="toggle" class="search-toggle-mobile d-flex d-lg-none align-items-center">
        <div class="d-flex ">
                                <i class="ki-outline ki-magnifier fs-1 fs-2"></i>                            </div>
    </div>
    <!--end::Tablet and mobile search toggle-->

<!--begin::Form(use d-none d-lg-block classes for responsive search)-->
<form style="display:none!important;" data-action="under-construction" data-kt-search-element="form" class="d-lg-block w-100 position-relative mb-5 mb-lg-0" autocomplete="off">	
...
<!--begin::Input-->
<input type="text" class="search-input form-control form-control form-control-solid h-lg-40px  ps-13" name="search" value="" placeholder="Nhập từ khóa tìm kiếm..." data-kt-search-element="input"/>
<!--end::Input-->
...
<div class="scroll-y mh-200px mh-lg-350px">
        ...
        <!--end::Category title-->
                ...
                <a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                    ...
                    <div class="symbol symbol-40px me-4">
                        <img src="/metronic8/demo56/assets/media/avatars/300-6.jpg" alt=""/>
                    </div>
                    <!--end::Symbol-->
                ...
                <a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                    <!--begin::Symbol-->
                    <div class="symbol symbol-40px me-4">
                        <img src="/metronic8/demo56/assets/media/avatars/300-2.jpg" alt=""/>
                    </div>
                    <!--end::Symbol-->
                ...
                <a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                    <!--begin::Symbol-->
                    <div class="symbol symbol-40px me-4">
                        <img src="/metronic8/demo56/assets/media/avatars/300-9.jpg" alt=""/>
                    </div>
                    <!--end::Symbol-->
                ...
                <a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                    <!--begin::Symbol-->
                    <div class="symbol symbol-40px me-4">
                        <img src="/metronic8/demo56/assets/media/avatars/300-14.jpg" alt=""/>
                    </div>
                    <!--end::Symbol-->
                ...
                <a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                    <!--begin::Symbol-->
                    <div class="symbol symbol-40px me-4">
                        <img src="/metronic8/demo56/assets/media/avatars/300-11.jpg" alt=""/>
                    </div>
                    <!--end::Symbol-->
        ...
        <!--end::Category title-->
                ...
                <a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                    ...
                    <div class="symbol symbol-40px me-4">
                        <span class="symbol-label bg-light">                             
                            <img class="w-20px h-20px" src="/metronic8/demo56/assets/media/svg/brand-logos/volicity-9.svg" alt=""/>                          
                        </span>
                    </div>
                    <!--end::Symbol-->
                ...
                <a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                    ...
                    <div class="symbol symbol-40px me-4">
                        <span class="symbol-label bg-light">                             
                            <img class="w-20px h-20px" src="/metronic8/demo56/assets/media/svg/brand-logos/tvit.svg" alt=""/>                          
                        </span>
                    </div>
                    <!--end::Symbol-->
                ...
                <a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                    ...
                    <div class="symbol symbol-40px me-4">
                        <span class="symbol-label bg-light">                             
                            <img class="w-20px h-20px" src="/metronic8/demo56/assets/media/svg/misc/infography.svg" alt=""/>                          
                        </span>
                    </div>
                    <!--end::Symbol-->
                ...
                <a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                    ...
                    <div class="symbol symbol-40px me-4">
                        <span class="symbol-label bg-light">                             
                            <img class="w-20px h-20px" src="/metronic8/demo56/assets/media/svg/brand-logos/leaf.svg" alt=""/>                          
                        </span>
                    </div>
                    <!--end::Symbol-->
                ...
                <a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                    ...
                    <div class="symbol symbol-40px me-4">
                        <span class="symbol-label bg-light">                             
                            <img class="w-20px h-20px" src="/metronic8/demo56/assets/media/svg/brand-logos/tower.svg" alt=""/>                          
                        </span>
                    </div>
                    <!--end::Symbol-->
...
<div class="d-flex justify-content-end">
    ...
    <a href="/metronic8/demo56/utilities/search/horizontal.html" class="btn btn-sm fw-bold btn-primary" data-kt-search-element="advanced-options-form-search">Search</a>
</div>
<!--end::Actions-->
</form>
<!--end::Preferences-->
