    ...
    <div class="row text-center">
        <div class="col-md-4">
            <div class="card shadow-sm py-4 border border-dark rounded">
                <div class="card-body">
                    <a href="{{ action([App\Http\Controllers\Hk\HostingController::class, 'index']) }}"
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6">
                    ...
                    <p class="fst-italic"><em>Đội ngũ chuyên gia của chúng tôi sẽ tư vấn và xây dựng website trọn gói
                            dành cho bạn</em></p>
                ...
                <div class="col-md-6">
                    <div class="p-4 custom-bg bg-opacity-10 rounded shadow-sm">
                        <p>Vui lòng điền thông tin của bạn để được tư vấn miễn phíg.</p>
                        <form id="contactForm" action="<?php echo esc_url(get_site_url()); ?>?page=hk&path=/main" method="post"
                            enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
                                <input type="text" class="form-control rounded-pill px-3" placeholder="Họ tên"
                                    required id="name" name="name">
                            </div>
                            <div class="mb-3">
                                <input type="text" class="form-control rounded-pill px-3" placeholder="SĐT" id="phone" name="phone" required>
                            </div>
                            <div class="mb-3">
                                <input type="email" class="form-control rounded-pill px-3" id="email" name="email" placeholder="Email"
                                    required>
                            </div>
                            <button form-control="save" type="submit" class="btn btn-danger rounded-pill w-100">Tư Vấn Cho Tôi</button>
                        </form>
                    </div>
                </div>
            </div>
